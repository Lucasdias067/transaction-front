...
export function Expense() {
  ...
  function handleSubmit(e: React.FormEvent<HTMLFormElement>) {
    ...
    alert('Despesa adicionada com sucesso! (Verifique o console para os dados)')
  ...
  return (
    <Sheet>
      <SheetTrigger asChild>
        <div className="text-left hover:bg-red-500/20 cursor-pointer rounded-xl p-2">
          <div className="font-medium text-red-400">Adicionar Despesa</div>
          <div className="text-sm opacity-75">Contas, compras, gastos...</div>
        </div>
      </SheetTrigger>
      <SheetContent className="w-full max-w-md h-full max-h-screen p-4 flex flex-col">
        ...
        <SheetHeader>
          ...
          <SheetDescription>
            Preencha os detalhes da sua despesa aqui. Clique em salvar quando
            terminar.
          </SheetDescription>
        </SheetHeader>
        <form
        ...
        >
          <div className="grid gap-3">
            ...
            <Input
              id="transaction-name"
              placeholder="Nome da transação (ex: Conta de luz)"
              value={title}
